...
SIGMA_TEMPLATES = {
    ...
    "T1566.001": {
        "title": "Spearphishing Attachment - Suspicious File in User Path",
        "logsource": {"product": "windows", "service": "sysmon"},
        "detection_field": "TargetFilename",
        "event_id": 11,
        "target_pattern": "*\\Downloads\\*.docm|*\\Downloads\\*.xlsm|*\\Temp\\*.hta|*\\Temp\\*.ps1",
    },
    "T1055": {
        ...
        "detection_field": "TargetImage",
        "event_id": 8,
        "target_pattern": "*notepad.exe|*explorer.exe|*svchost.exe",
    },
    "T1134": {
        "title": "Access Token Manipulation - whoami Privilege Enumeration",
        "logsource": {"product": "windows", "service": "sysmon"},
        "detection_field": "CommandLine",
        "event_id": 1,
        "target_pattern": "*whoami*/priv*|*whoami*/all*",
    },
    "T1562.001": {
        "title": "Disable Windows Defender via PowerShell",
        "logsource": {"product": "windows", "service": "sysmon"},
        "detection_field": "CommandLine",
        "event_id": 1,
        "target_pattern": "*Set-MpPreference*Disable*",
    },
    "T1027": {
        "title": "Obfuscated PowerShell via EncodedCommand",
        "logsource": {"product": "windows", "service": "sysmon"},
        "detection_field": "CommandLine",
        "event_id": 1,
        "target_pattern": "*-EncodedCommand*|* -enc *|* -ec *",
    },
    "T1112": {
        "title": "Modify Registry via reg.exe or PowerShell",
        "logsource": {"product": "windows", "service": "sysmon"},
        "detection_field": "TargetObject",
        "event_id": 13,
        "target_pattern": "*\\SOFTWARE\\*",
    },
    "T1082": {
        ...
        "detection_field": "Image",
        "event_id": 1,
        "target_pattern": "*systeminfo.exe|*hostname.exe",
    },
    "T1083": {
        "title": "File and Directory Discovery via dir or Get-ChildItem",
        "logsource": {"product": "windows", "service": "sysmon"},
        "detection_field": "CommandLine",
        "event_id": 1,
        "target_pattern": "*dir */s*|*Get-ChildItem*-Recurse*",
    },
    "T1069.001": {
        "title": "Local Permission Group Discovery via net localgroup",
        "logsource": {"product": "windows", "service": "sysmon"},
        "detection_field": "CommandLine",
        "event_id": 1,
        "target_pattern": "*net*localgroup*",
    },
    "T1016": {
        "title": "Network Configuration Discovery via ipconfig/arp/netstat",
        "logsource": {"product": "windows", "service": "sysmon"},
        "detection_field": "Image",
        "event_id": 1,
        "target_pattern": "*ipconfig.exe|*arp.exe|*netstat.exe|*nbtstat.exe",
    },
    "T1018": {
        "title": "Remote System Discovery via net view",
        "logsource": {"product": "windows", "service": "sysmon"},
        "detection_field": "CommandLine",
        "event_id": 1,
        "target_pattern": "*net*view*",
    },
    "T1550.002": {
        "title": "Pass-the-Hash via sekurlsa or CrackMapExec",
        "logsource": {"product": "windows", "service": "sysmon"},
        "detection_field": "CommandLine",
        "event_id": 1,
        "target_pattern": "*sekurlsa::pth*|*crackmapexec*-H*",
    },
    "T1071.001": {
        "title": "C2 Beacon over HTTP from Non-Browser Process",
        "logsource": {"product": "windows", "service": "sysmon"},
        "detection_field": "DestinationPort",
        "event_id": 3,
        "target_pattern": "80|443|8080|8443",
    },
    "T1048": {
        "title": "Exfiltration over Alternative Protocol - Non-Standard Port",
        "logsource": {"product": "windows", "service": "sysmon"},
        "detection_field": "DestinationPort",
        "event_id": 3,
        "target_pattern": "21|4444|6666|6667|8443|9001|1337",
    },
    "T1490": {
        ...
        "detection_field": "CommandLine",
        "event_id": 1,
        "target_pattern": "*vssadmin*delete*shadows*",
    },
    "T1486": {
        "title": "Ransomware File Encryption - Suspicious Extension Created",
        "logsource": {"product": "windows", "service": "sysmon"},
        "detection_field": "TargetFilename",
        "event_id": 11,
        "target_pattern": "*.encrypted|*.locked|*.enc|*.wncry|*.crypt",
    },
}
